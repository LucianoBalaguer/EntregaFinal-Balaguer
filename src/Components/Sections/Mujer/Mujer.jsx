...
import { getProductsForWoman } from "../../../FireBase/FireBase";
...
export default function Intermedio(){
    ...
    useEffect(() => {
        ...
        getProductsForWoman().then((products) => setProds(products));

    }, []);

    return(<>
        
        <h1 className='position-absolute start-0 tipografia' style={{top:150, marginLeft:26, color: "white"}}>Productos de Mujer </h1>
